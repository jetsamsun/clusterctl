                        ...
                        dds.on('click', function(){
                            ...
                            if (isMulti) {
                                ...
                                if(othis.find("input[type='checkbox']").is(':checked')){
                                    if (omit) {
                                        multiSelect.html(multiSelect.html() + "<a href='javascript:;'><span lay-value='"+othis.attr('lay-value')+"'>"+othis.find("span").text()+"</span><i style='width: 16px; height: 16px;'></i></a>");
                                    } else {
                        ...
                        function handleMultiOption () {
                            ...
                            if (omit) {
                                ...
                                for (var i = 0; i < selectedOption.length; i++) {
                                    options.push("<a href='javascript:;'><span lay-value='"+(selectedOption[i].value||selectedOption[i].text)+"'>"+selectedOption[i].text+"</span><i style='width: 16px; height: 16px;'></i></a>");
                                }
                                ...
                                if(typeof $(select).attr("lay-omit")==='undefined' && value != null && value != undefined && value.length != 0){
                                    for(var aList = 0;aList<value.length;aList++){
                                        if(value[aList]){
                                            ...
                                            aLists.push("<a href='javascript:;'><span lay-value='"+chooseValue+"'>"+chooseText+"</span><i style='width: 16px; height: 16px;'></i></a>")
                                        }
                                    }
                                }
                                return aLists.join('');
                    ...
                    var hasRender = othis.next('.' + RE_CLASS[0])
                        ...
                        ,function(){ //不同风格的内容
                            var title = check.title.replace(/\s/g, '')
                                ...
                                //开关
                                ,_switch: '<em>'+ ((check.checked ? text[0] : text[1]) || '') +'</em><i style="width: 16px; height: 16px;"></i>'
                            };
