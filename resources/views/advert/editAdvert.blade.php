...
@section('content')
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend>广告编辑表单</legend>
    </fieldset>

    <form class="layui-form" action="{{ url('/admin/advert/editAdvert/'.$advertId) }}" method="post">
        <div class="layui-form-item">
            <label class="layui-form-label"><font color="red">* </font>标题</label>
            <div class="layui-input-block">
                <input type="text" name="title" lay-verify="required" autocomplete="off" placeholder="请输入广告标题" class="layui-input" value="{{ $data['title'] }}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label"><font color="red">* </font>跳转链接 </label>
            <div class="layui-input-block">
                <input type="text" name="url" lay-verify="required" autocomplete="off" placeholder="请输入广告跳转链接" class="layui-input" value="{{ $data['url'] }}">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="otype" lay-filter="myselect"  lay-verify="required">
                    <option value=""></option>
                    <option @if($data['otype']==1) selected @endif value="1">播放器</option>
                    <option @if($data['otype']==5) selected @endif value="2">播放列表</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
