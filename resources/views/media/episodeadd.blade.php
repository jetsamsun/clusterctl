...
@section('content')
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend>新增视频地址表单</legend>
    </fieldset>

    <form class="layui-form" action="{{ url('/admin/media/addepisode/'.$mid) }}" method="post">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <div class="m3u8_item">
                    <input type="text" name="Play_url" style="margin-bottom: 7px; width: 600px; float: left" class="layui-input fuz m3u8css" value="">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="Code" value="" autocomplete="off" placeholder="请输入码率" class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="Play_time" value="" autocomplete="off" placeholder="请输入总播放时间" class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="Lang" value="" autocomplete="off" placeholder="请输入语言" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">第几季</label>
                <div class="layui-input-inline">
                    <input type="text" name="Season" value="" autocomplete="off" placeholder="请输入季数" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">第几集</label>
                <div class="layui-input-inline">
                    <input type="text" name="Episode"  value="" autocomplete="off" placeholder="请输入集数" class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="Play_node" value="" autocomplete="off" placeholder="关键结点,按秒数" class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="Source" value="" autocomplete="off" placeholder="来源,如youtube" class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入简介" name="Description"  class="layui-textarea"></textarea>
            </div>
        </div>
